...
<body class="">
    <div class="page d-flex">
        <section class="sidebar sticky-top text-center py-4 px-3">
            ...
            <button type="button" data-bs-toggle="modal" data-bs-target="#addTaskModal" name="add task" id="addTaskBtn"
                class="add-task-btn btn shadow-sm mt-5 mx-auto d-flex align-items-center gap-4 py-2 px-3">
            ...
            <ul class="text-capitalize list-unstyled mt-5 d-flex flex-column gap-3">
                <li>
                    <a id="allFilterBtn" filter="all" role="button"
                        class="filter-btn d-block text-decoration-none text-black p-3 text-start dashbaord__tab dashbaord__tab--active rounded">
                        <i class="fa-solid fa-chart-line me-2"></i>
                        <span>dashboard</span>
                    </a>
                </li>
                <li>
                    <a id="activeFilterBtn" filter="active" role="button"
                        class="filter-btn d-block text-decoration-none text-black p-3 text-start dashbaord__tab rounded">
                        <i class="fa-solid fa-clock me-2"></i>
                        <span>active</span>
                    </a>
                </li>
                <li>
                    <a id="completeFilterBtn" filter="complete"
                        class="filter-btn d-block text-decoration-none text-black p-3 text-start dashbaord__tab  rounded"
                        role="button">
        ...
        <section class="main w-100">
            <header class="header sticky-top py-3 px-4 d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center gap-3">
                    <div role="button" class="d-flex align-items-center gap-1" data-bs-toggle="offcanvas"
                        data-bs-target="#offcanvasUserProfile" aria-controls="offcanvasUserProfile">
                        <img class="user-img rounded-pill" width="40" class="img-fluid"
                            src="https://cdn-icons-png.freepik.com/512/7139/7139450.png" alt="use image not found">
                        <i class="fa-solid fa-circle-chevron-down text-main-red"></i>
                    </div>
                    <a href="controllers/sign_out.php" type="button" name="" id=""
                        class="btn text-white main-btn-red d-flex align-items-center gap-2">
            ...
            <section class="content px-4 py-5">
                <div class="hero bg-main-white shadow-sm position-relative px-5 rounded d-flex align-items-center">
                    <div class="text-box">
                        <h2 class="fs-1 fw-bold text-capitalize">Hello, Beautiful <span id="userName"
                                class="text-main-red">Human!</span></h2>
                ...
                <section class="tasks mt-5">
                    <div class="tasks__text-wrapper text-capitalize d-flex align-items-center justify-content-between">
                        ...
                        <span id="openDeleteAllTaskModalBtn" data-bs-toggle="modal" data-bs-target="#deleteAllTaskModal"
                            role="button" class="text-main-red">Delete all</span>
                    </div>
    ...
    <!-- add task Modal -->
    <div class="modal fade" data-bs-backdrop="static" id="addTaskModal" tabindex="-1" aria-labelledby="addTaskModal"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="group mb-3">
                        ...
                        <input type="text" class="form-control form-control-md border border-secondary-subtle"
                            name="task name" id="taskName" aria-describedby="taskNameHelp" placeholder="" />
    ...
    <!-- delete all modal -->
    <div class="modal fade" data-bs-backdrop="static" id="deleteAllTaskModal" tabindex="-1"
        aria-labelledby="deleteAllTaskModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title text-capitalize fs-5 fw-semibold" id="deleteAllTaskModal">delete all tasks
                    </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <span>Please note that this action will delete all tasks, and they cannot be restored. Are you sure
                        you want to delete them?</span>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">cancel</button>
    ...
    <div class="offcanvas offcanvas-end offcanvas-user-profile" tabindex="-1" id="offcanvasUserProfile"
        aria-labelledby="offcanvasUserProfile">
        ...
        <div class="offcanvas-body">
            <div class="text-center">
                <img class="user-img rounded-pill" width="120" class="img-fluid"
                    src="https://cdn-icons-png.freepik.com/512/7139/7139450.png" alt="use image not found">
